...
function ProductsSection() {
  return ( 
    <div className="flex flex-wrap items-center m-5 max-w-[1100px] max-[800px]:flex-col">
      <div className="flex-1">
        <div className="flex flex-col gap-7 mr-2">
          ...
          <h1 className="text-2xl text-black -mb-5">No spam or gimmicks</h1><p className="text-gray-500 text-[17px]">No gimmicks, spam, "gamification", or annoying push notifications. High quality apps that you use at your pace, the way you like. <span className="text-blue-600 cursor-pointer">Our philosophies.</span></p>
          ...
          <h1 className="text-2xl text-black -mb-5">Do better with money</h1><p className="text-gray-500 text-[17px]">With initiatives like <span className="text-blue-600 cursor-pointer">Nudge</span> and <span className="text-blue-600 cursor-pointer">Kill Switch</span>, we don't just facilitate transactions, but actively help you do better with your money.</p>
        </div>
      </div>
      <div className="flex-1"><img src={productsImage} alt="products" className="w-full h-auto"/></div>
    </div>
   );
}
