    ...
    <div className="flex flex-wrap items-center m-5 max-w-[1100px]">
      <div className="flex-1">
        <div className="flex flex-col gap-7 mr-2 min-w-[300px]">
          ...
          <h1 className="text-2xl text-black -mb-5">Customer-first always</h1><p className="text-gray-500 text-[17px]">That's why 1.6+ crore customers trust Zerodha with ~ ₹6 lakh crores of equity investments, making us India’s largest broker; contributing to 15% of daily retail exchange volumes in India.</p>
          ...
          <h1 className="text-2xl text-black -mb-5">The Zerodha universe</h1><p className="text-gray-500 text-[17px]">Not just an app, but a whole ecosystem. Our investments in 30+ fintech startups offer you tailored services specific to your needs.</p>
